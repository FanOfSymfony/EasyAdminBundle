...
class TranslationController extends Controller
{
     ...
     *
     * @Route("/eatb/redirect-to-translation/{entityName}/{parentId}/{languageId}/{action}", name="redirect-to-translation", methods={"GET"})
    ...
    public function redirectToTranslationEditFormAction(Request $request, $entityName, $parentId, $languageId, $action)
    {
        ...
        // Get language entity
        $language = $this->getDoctrine()->getManager()->getRepository('EasyAdmin:Language')->findOneById($languageId);
     ...
     *
     * @Route("/eatb/close-tab/{entityName}/{parentId}/{languageId}", name="eatb-close-tab", methods={"GET"})
     * @return RedirectResponse
     */
