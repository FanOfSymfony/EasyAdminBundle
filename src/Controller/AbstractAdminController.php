...
class AbstractAdminController extends Controller
{
    ...
    protected function searchAction()
    {
        ...
        if ('' === $query) {
            $queryParameters = array_filter(array_replace($this->request->query->all(), ['action' => 'list', 'query' => null]));
    ...
    protected function embeddedListAction()
    {
        ...
        return $this->render('@EasyAdmin/default/embedded_list.html.twig', array(
            'paginator' => $paginator,
            'fields' => $fields,
