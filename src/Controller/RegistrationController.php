...
use FanOfSymfony\Bundle\EasyAdminBundle\Event\FormEvent;
use FanOfSymfony\Bundle\EasyAdminBundle\Event\GetResponseUserEvent;
use FanOfSymfony\Bundle\EasyAdminBundle\Form\Factory\FactoryInterface;
use FanOfSymfony\Bundle\EasyAdminBundle\UserEvents;
use FanOfSymfony\Bundle\EasyAdminBundle\Model\UserInterface;
use FanOfSymfony\Bundle\EasyAdminBundle\Model\UserManagerInterface;
...
class RegistrationController extends Controller
{
     ...
     *
     * @return Response
     * @Route("/register", name="easy_admin_registration_register")
     */
        ...
        if ($form->isSubmitted()) {
            if ($form->isValid()) {
                ...
                if (null === $response = $event->getResponse()) {
                    $url = $this->generateUrl('easy_admin_registration_confirmed');
    ...
    /**
     * @Route("/check-email", name="easy_admin_registration_check_email")
     */
