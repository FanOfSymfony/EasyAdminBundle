    ...
    private function addGlobalOptionsSection(ArrayNodeDefinition $rootNode)
    {
        $rootNode
            ->children()
                ...
                ->end()
                ->scalarNode('user_class')->defaultValue('FanOfSymfony\\Bundle\\EasyAdminBundle\\Model\\BaseUser')->cannotBeEmpty()->end()
                ->scalarNode('firewall_name')->defaultValue('main')->cannotBeEmpty()->end()
                ...
                ->addDefaultsIfNotSet()
                ->children()
                ->scalarNode('address')->defaultValue('no-reply@easyadmin.io')->cannotBeEmpty()->end()
                ->scalarNode('sender_name')->defaultValue('EasyAdmin')->cannotBeEmpty()->end()
                ->end()
                ->end()
